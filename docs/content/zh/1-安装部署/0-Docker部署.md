...
```bash
docker run -v /zhiqingyun/resources:/var/lib/lucene-yun -p 8080:8080 -d isxcode/zhiqingyun
```
...
spring:
  ...
  datasource:
    ...
    url: jdbc:h2:file:/var/lib/lucene-yun/h2/data
    username: root
    password: root123
  ...
  quartz:
    properties:
      ...
      org.quartz.dataSource.quartzDataSource.URL: jdbc:h2:file:/var/lib/lucene-yun/h2/data
      org.quartz.dataSource.quartzDataSource.user: root
      org.quartz.dataSource.quartzDataSource.password: root123
```

```bash
docker run -v /zhiqingyun/config:/etc/lucene-yun/conf -e ACTIVE_ENV=demo -p 8080:8080 -d isxcode/zhiqingyun
```