...
git clone https://github.com/isxcode/lucene-yun.git
```
...
tar vzxf spark-3.4.0-bin-hadoop3.tgz --strip-components=1 -C lucene-yun/lucene-yun-dist/src/main/spark-min
```
...
```bash
cd lucene-yun
git clone https://github.com/isxcode/lucene-yun-vip.git
```
