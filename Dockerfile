...
COPY lucene-yun-backend/lucene-yun-main/build/libs/zhiliuyun.jar /opt/zhiliuyun/zhiliuyun.jar
COPY lucene-yun-backend/lucene-yun-main/src/main/resources/application-docker.yml /etc/zhiliuyun/conf/
